...
#define HUE_CAPABILITIES "{\"certified\":false,\"control\": {},\"streaming\":{\"renderer\":false,\"proxy\":false}}"
#endif
#ifdef COLOR_TEMP
...
#endif
#endif
    "\"alert\":\"none\",\"mode\":\"homeautomation\",\"reachable\":true},"
    "\"capabilities\": " HUE_CAPABILITIES ",\"swversion\":\"5.105.0.21169\"}";

// Use shorter description template when listing all devices
const char FAUXMO_DEVICE_JSON_TEMPLATE_SHORT[] = "{"
    "\"type\": \"" HUE_TYPE "\","
    "\"name\": \"%s\","
    "\"uniqueid\": \"" MACSTR ":00:11-%02x\","
    "\"modelid\":\"" HUE_MODEL_ID "\","
